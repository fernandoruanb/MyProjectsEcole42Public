...
/*   Updated: 2025/05/29 11:58:43 by fruan-ba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat::Bureaucrat(const std::string name, int grade): name(name), grade(grade)
{
	...
	std::cout << "Default constructor called for " << this->getName() << " Bureaucrat";
}

Bureaucrat::~Bureaucrat(void)
{
	std::cout << "Destructor called for " << this->getName() << " Bureaucrat";
}

Bureaucrat::Bureaucrat(const Bureaucrat &other): name(other.getName()), grade(other.getGrade())
{
	(void)other;
	std::cout << "Copy constructor called for " << this->getName() << " Bureaucrat";
}
