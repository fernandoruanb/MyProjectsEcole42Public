...
/*   Updated: 2025/02/02 12:14:59 by fruan-ba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv, char **envp)
{
	...
	add_token(&root, "/usr/bin", ARG);
	add_token(&root, "/usr/local/bin", ARG);
	add_token(&root, "/bin/sbin", ARG);
	add_token(&root, "--color=auto", ARG);
